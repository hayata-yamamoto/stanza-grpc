...
import grpc
from src.pb2 import health_pb2, health_pb2_grpc
...
class HealthService(health_pb2_grpc.HealthServicer):
    ...
    def Watch(self, request: health_pb2.HealthCheckRequest,
              context: grpc.ServicerContext) -> Iterator[health_pb2.HealthCheckResponse]:
        is_alive = HealthUsecase.alive()
